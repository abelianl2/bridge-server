...
CREATE TABLE `deposit` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `ids` (`from_network`,`from_address`,`to_network`,`to_address`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='存款表';
